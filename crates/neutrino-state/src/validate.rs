//! Phase 1: wire-format validation.
//!
//! Every check in this module corresponds to a specific "reject" / required-
//! field condition in either:
//! - the v12 spec (<https://spec.matrix.org/v1.18/rooms/v12/>), or
//! - MSC4242 (State DAGs).
//!
//! Each check is annotated inline with its spec citation. Anything that
//! requires a state lookup or DAG walk is deferred to a later phase.

use ruma::{OwnedEventId, OwnedRoomId, OwnedUserId};
use serde_json::value::RawValue;
use serde_json::{Map, Value};

use crate::{Event, FormatError, RoomVersion};
